...
public class BusCustomerServiceImpl implements BusCustomerService {
    ...
    public Result add(BusCustomerForm form) {
        ...
        BusCustomerVO busCustomerVO = busCustomerMapper.selectByIdCardOrPhone(busCustomerQuery);
        ...
        busCustomerVO = busCustomerMapper.selectByIdCardOrPhone(busCustomerQuery);
        if (busCustomerVO!=null){
                ...
                if (list.get(i)!=null && list.get(i)!=""){
                    ...
                    switch (i){
                        ...
                        case 2:vo.setPhone(value);
                            break;
                        case 3:vo.setAddress(value);
                            break;
                        case 4:vo.setIdCard(value);
                            break;
                        case 5:vo.setSex(Integer.parseInt(value));
                            break;
                        default:
                            break;
                    }
